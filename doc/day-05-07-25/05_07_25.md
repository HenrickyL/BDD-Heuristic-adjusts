...
6. Antes de ver melhor a parte de estudo de BDD fui terminar de refatorar algumas coisas.
7. Pesquisei o ajuste de memória máxima `-Xmx10g -Xms512m`. Consegui aplicar no `intellij`.